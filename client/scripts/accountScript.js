...
async function getAccountInfo(accountId) {
    ...
    <table id="summary-table">
        ...
        <tr><td>Account Number</td><td>${accountInfo.data._id}</td></tr>
        <tr><td>Account Type</td><td>${accountInfo.data.type}</td></tr>
        <tr><td>Account Balance</td><td>${accountInfo.data.balance}</td></tr>
        <tr><td>Account Status</td><td>${accountInfo.data.status}</td></tr>
      </table>`;
